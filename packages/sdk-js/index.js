...
/**
 * BodapayClient — official JavaScript client for the Bodapay API.
 *
 * Usage:
 *   const { BodapayClient } = require("@bodapay/sdk");
 *   const client = new BodapayClient({ baseUrl: "https://api.example.com" });
