# Uptime Monitoring — Bodapay

> Issue [#280](https://github.com/anitajordan22244-afk/Bodapay/issues/280) — External uptime monitoring via UptimeRobot

## Status

| Monitor | Status |
|---|---|
| Overall | [![Uptime Robot status](https://img.shields.io/uptimerobot/status/REPLACE_WITH_MONITOR_ID?label=Overall&style=flat-square)](https://status.bodapay.example.com) |
| Health Check | [![Uptime Robot ratio](https://img.shields.io/uptimerobot/ratio/REPLACE_WITH_HEALTH_MONITOR_ID?style=flat-square&label=Health)](https://status.bodapay.example.com) |
| Frontend | [![Uptime Robot ratio](https://img.shields.io/uptimerobot/ratio/REPLACE_WITH_FRONTEND_MONITOR_ID?style=flat-square&label=Frontend)](https://status.bodapay.example.com) |
| API | [![Uptime Robot ratio](https://img.shields.io/uptimerobot/ratio/REPLACE_WITH_API_MONITOR_ID?style=flat-square&label=API)](https://status.bodapay.example.com) |
...
Public status page: https://status.bodapay.example.com

---

## Overview

All critical Bodapay endpoints are monitored every **5 minutes** from
...
2. Verify manually: `curl -I https://bodapay.example.com/health`
3. Check pod logs: `kubectl logs -l app=bodapay-backend --tail=100`
4. Check k8s deployment status: `kubectl get pods -l app=bodapay-backend`
