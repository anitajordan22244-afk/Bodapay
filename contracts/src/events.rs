...
pub enum EventData {
    ...
    // invoice_id, escrow_id, sender, recipient, asset, amount, total_due (amount + fees)
    InvoiceCreated(u64, u64, Address, Address, AssetRef, i128, i128),
...
pub fn emit(
    ...
    {
        env.events().publish(
            (symbol_short!("bodapay"), component, action, id),
            BodapayEvent {
