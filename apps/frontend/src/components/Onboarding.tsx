...
const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    title: "Welcome to Bodapay",
    badge: "Getting Started",
    description:
      "Bodapay is a next-generation cross-border payment platform powered by the Stellar network. Send funds globally in seconds with ultra-low fees, real-time FX rates, and bank-grade security.",
    icon: "🌐",
    highlights: [
...
const STORAGE_KEY = "bodapay_onboarding_completed";
