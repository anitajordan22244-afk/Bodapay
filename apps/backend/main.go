...
import (
	...
	"github.com/anitajordan22244-afk/bodapay/config"
	"github.com/anitajordan22244-afk/bodapay/graphql"
	"github.com/anitajordan22244-afk/bodapay/handlers"
	"github.com/anitajordan22244-afk/bodapay/models"
	"github.com/anitajordan22244-afk/bodapay/logger"
	"github.com/anitajordan22244-afk/bodapay/metrics"
	"github.com/anitajordan22244-afk/bodapay/middleware"
	"github.com/anitajordan22244-afk/bodapay/services"
	"github.com/anitajordan22244-afk/bodapay/utils"
	"github.com/anitajordan22244-afk/bodapay/workers"
)
...
func main() {
	...
	go func() {
		logger.Log.WithField("port", cfg.Port).Info("Starting Bodapay API server")
