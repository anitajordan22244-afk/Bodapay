...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for using Bodapay!</p>
        </div>
        <div class="footer">
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We received a request to reset your password for your Bodapay account.</p>
...
`
	...
	subject := "Password Reset Request - Bodapay"
	return s.SendEmail(user.Email, subject, body.String())
}
